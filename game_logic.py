...
def reset_turn(self, reset_board: bool = True) -> None:
    """
...
def is_legal_drop(self, x: int, y: int) -> bool:
    """
...
def is_legal_move(self, n: int, d: Tuple[int, int]) -> bool:
    """
...
def legal_moves(self) -> List[Tuple[Union[Tuple[int, int], int], Optional[Tuple[int, int]]]]:
...
def add_drop(self, x: int, y: int) -> None:
...
def add_move(self, n: int, d: List[int]) -> None:
    """
...
def add_turn(self, turn: List[Tuple[int]]) -> None:
    """
